...
- **Improved Gesture System:** Highly responsive swipe detection optimized for both physical touchscreens and mouse input (emulators).
- **Dual Input Support:**
...
5. **Game Over:** The game ends when the grid is full and no more moves are available. Use the **Try Again** button to restart.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/yourusername/mini_game_01.git
   ```
